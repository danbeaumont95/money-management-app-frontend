...
ChartJS.register(ArcElement, Tooltip, Legend, CategoryScale, LinearScale, LineController, BarElement);
  ...
  render() {
      ...
      datasets: [
        {
          ...
          data: [this.state.transactions.filter((el) => el.payment_channel === "in store").length, this.state.transactions.filter((el) => el.payment_channel === "online").length],
          backgroundColor: [
            'rgba(255, 99, 132, 0.2)',
            'rgba(54, 162, 235, 0.2)'
            ],
    ...
    const amountSpentData = {
      ...
      datasets: [{
        ...
        data: getAmountSpentPerAmount(this.state.transactions),
        backgroundColor: [
          'rgba(54, 162, 235, 0.2)',
          'rgba(54, 162, 235, 0.2)',
          'rgba(54, 162, 235, 0.2)',
